    ...
    <footer className="flex flex-col relative items-center justify-center border-t border-border pt-16 pb-8 px-6 lg:px-8 w-full max-w-6xl mx-auto lg:pt-32">
      ...
      <div className="grid gap-8 xl:grid-cols-3 xl:gap-8 w-full">
        <div className="flex flex-col items-start justify-start md:max-w-[200px]">
          ...
          <p className="text-muted-foreground mt-4 text-sm text-start">
            Athletix é uma plataforma prática para facilitar o contato entre
            treinadores e atletas no mundo futebolístico.
          </p>
        ...
        <div className="grid-cols-2 gap-8 grid mt-16 xl:col-span-2 xl:mt-0">
          <div className="md:grid md:grid-cols-2 md:gap-8">
            <div className="">
              <h3 className="text-base font-medium">Athletix</h3>
            ...
            <div className="mt-10 md:mt-0 flex flex-col">
              <h3 className="text-base font-medium">Páginas</h3>
              <ul className="mt-4 text-sm text-muted-foreground">
                <li className="">
                  <Link
                    href=""
      ...
      <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 flex items-center justify-between w-full">
        <p className="text-sm text-muted-foreground">
          &copy; {new Date().getFullYear()} Athletix. Todos os direitos
          reservados.
        </p>
